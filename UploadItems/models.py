...
class Items(models.Model):
    ...
    cur_highest_bidder = models.ForeignKey(User, related_name="highest_bidder", null=True, blank=True, on_delete=models.CASCADE)
...
class Bought(models.Model):
    ...
    item_name = models.CharField(max_length=2500)
    item_desc = models.TextField(max_length=2500)
    buyer = models.ForeignKey(User, related_name="buyer", null=True, blank=True, on_delete=models.CASCADE)
